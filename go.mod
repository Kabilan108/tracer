...
require (
	...
	go.opentelemetry.io/otel v1.43.0 // send observability data to observability platforms
	...
	golang.org/x/text v0.35.0 // Text processing and Unicode normalization
